...
public class tinycParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "paren_expr", "expr", "test", "sum", "term", 
			"id", "integer"
		};
	}
	...
	public tinycParser(CommonTokenStream input) {
		super(input);
	...
	public static class SumContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof tinycVisitor) return ((tinycVisitor<? extends T>)visitor).visitSum(this);
			else return visitor.visitChildren(this);
		}
	}
