...
class tinycParser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def id(self):
            return self.getTypedRuleContext(tinycParser.IdContext,0)
    ...
    class TestContext(ParserRuleContext):
        ...
        def sum(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(tinycParser.SumContext)
            else:
                return self.getTypedRuleContext(tinycParser.SumContext,i)
    ...
    class SumContext(ParserRuleContext):
        ...
        def sum(self):
            return self.getTypedRuleContext(tinycParser.SumContext,0)
    ...
    def sum(self, _p:int=0):
        ...
        localctx = tinycParser.SumContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 10
        self.enterRecursionRule(localctx, 10, self.RULE_sum, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 76
            self.term()
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = tinycParser.SumContext(self, _parentctx, _parentState)
    ...
    def id(self):
        ...
        localctx = tinycParser.IdContext(self, self._ctx, self.state)
    ...
    def sempred(self, localctx:RuleContext, ruleIndex:int, predIndex:int):
        ...
        self._predicates[5] = self.sum_sempred
